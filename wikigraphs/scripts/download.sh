...
mkdir -p ${TARGET_DIR}
wget https://wikitext.smerity.com/wikitext-103-v1.zip -P ${TARGET_DIR}
...
mkdir -p ${TARGET_DIR}
wget https://wikitext.smerity.com/wikitext-103-raw-v1.zip -P ${TARGET_DIR}
...
FREEBASE_TARGET_DIR=$TARGET_DIR
